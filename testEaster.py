...
<days>
    ...
    def testWeekdayAfterDate(self):
        ...
        self.assertEqual(Easter.getWeekdayAfterDate(14, 1, 2012, 1, 7), datetime.date(2012, 1, 15))
        ...
        self.assertEqual(Easter.getWeekdayAfterDate(15, 2, 2012, 1, 7), datetime.date(2012, 2, 19))
        self.assertEqual(Easter.getWeekdayAfterDate(19, 1, 2013, 1, 6), datetime.date(2013, 1, 26))
        
    def testWeekdayBeforeDate(self):
        self.assertEqual(Easter.getWeekdayBeforeDate(1, 1, 2012, 1, 6), datetime.date(2011, 12, 31))
        self.assertEqual(Easter.getWeekdayBeforeDate(19, 1, 2012, 1, 6), datetime.date(2012, 1, 14))
        self.assertEqual(Easter.getWeekdayBeforeDate(10, 1, 2012, 1, 2), datetime.date(2012, 1, 3))
